...
function MixCharniComponent() {
    ...
    const tableName = "mixcharni"

    // const rows = [
    //     { name: "0.041-0.079", code: "0.041-0.079", from: "0.0410", to: "0.0790", order: 2, status: "Active" },
    ...
    //     { name: "0.01-0.04", code: "0.01-0.04", from: "0.0100", to: "0.0409", order: 1, status: "Active" },
